...
class SendTest extends TestCase
{
    ...
    public function testSendResponseFail(): void
    {
        // fake driver
        $sender = new EventSender(
    ...
    public function testSendFail(): void
    {
        ...
        $this->expectExceptionMessageMatches('/^Error sending file .*/');
    ...
    public function testSendDriverFail(): void
    {
        // real driver and real client -> throw exception
    ...
    public function testSendBackupFail(): void
    {
        // real driver and real client -> throw exception
